...
CONFIGS: dict[str, GlmHmmConfig] = {
    ...
    "normalized_stimulus_with_color_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_coherence", "prev_choice_coherence"),
        standardize_inputs=("color", "prev_choice", "prev_coherence", "prev_choice_coherence"),
        add_bias=False,
    ),
    "no_standardization_curr_stim_color_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_coherence", "prev_choice_coherence"),
        add_bias=False,
    ),
    "no_standardization_curr_stim_color_prev_choiceXtarget_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_target", "prev_choice_target"),
        add_bias=False,
    ),
    "no_standardization_curr_stim_color_no_prev_coh_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_coherence"),
        add_bias=False,
    ),
    "no_standardization_curr_stim_color_prev_choiceXtarget_no_prev_target_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_target"),
        add_bias=False,
    ),
    # No prev coh/target
    "standardized_stimulus_with_color_no_prev_coh": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_coherence"),
        standardize_inputs=("standardized_stimulus", "color", "prev_choice", "prev_choice_coherence"),
        add_bias=True,
    ),
    "normalized_stimulus_with_color_no_prev_coh": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_coherence"),
        standardize_inputs=("color", "prev_choice", "prev_choice_coherence"),
        add_bias=True,
    ),
    # No prev coh/target no bias
    "standardized_stimulus_with_color_no_prev_coh_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_coherence"),
        standardize_inputs=("standardized_stimulus", "color", "prev_choice", "prev_choice_coherence"),
        add_bias=False,
    ),
    "normalized_stimulus_with_color_no_prev_coh_no_bias": GlmHmmConfig(
        current_trial_features=("stimulus", "color"),
        prev_trial_features=("prev_choice", "prev_choice_coherence"),
        standardize_inputs=("color", "prev_choice", "prev_choice_coherence"),
        add_bias=False,
